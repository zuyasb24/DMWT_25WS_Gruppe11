          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-lg text-white bg-black/30 border border-white/10 focus:outline-none focus:ring-2 focus:ring-green-400"
              />
            </div>
            ...
            <select
              ...
              className="px-4 py-2 rounded-lg text-white bg-black/30 border border-white/10 focus:outline-none focus:ring-2 focus:ring-green-400"
            >
